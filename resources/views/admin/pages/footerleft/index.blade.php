...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">Footerleft Table
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="dataTableHover table table-striped table-bordered first">
                            <thead>
                            <tr>
                                <th>{{ __('footerleft_image')}}</th>
                                <th>{{ __('footerleft_title')}}</th>
...
<script>
    $(document).ready(function () {
        $('.dataTableHover').DataTable({
            ...
            columns: [
                {
                    data: 'footerleft_image',
                    name: 'footerleft_image'
                },
                {
                    data: 'footerleft_title',
                    name: 'footerleft_title'
                },
                {
                    data: 'action',
                    name: 'action',
